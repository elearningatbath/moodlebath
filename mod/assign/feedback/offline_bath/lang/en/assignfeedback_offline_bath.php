...
/**
 * Strings for component 'feedback_offline_bath', language 'en'
 *
...
$string['downloadgrades'] = 'Download grading worksheet (Bath version)';
$string['enabled'] = 'Offline grading worksheet (Bath version)';
$string['enabled_help'] = 'If enabled, the teacher will be able to download and upload a worksheet with student grades when marking the assignments. This specific worksheet was created for the needs of the University of Bath.';
...
$string['offline_bathgradingworksheet'] = 'Grades';
$string['pluginname'] = 'Offline grading worksheet (Bath version)';
