 ...
 *
 *
 * @package   assignfeedback_offline_bath
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assign_feedback_offline_bath extends assign_feedback_plugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'assignfeedback_offline_bath');
    }
    ...
    public function process_import_grades($draftid, $importid, $ignoremodified) {
        ...
        $gradeimporter = new assignfeedback_offline_bath_grade_importer($importid, $this->assignment);
        ...
        if (!$gradeimporter->init()) {
            ...
            print_error('invalidgradeimport', 'assignfeedback_offline_bath', $thisurl);
            return;
        }
        ...
        $o .= $renderer->render(new assign_header($this->assignment->get_instance(),
                                                  ...
                                                  get_string('importgrades', 'assignfeedback_offline_bath')));
        $o .= $renderer->box(get_string('updatedgrades', 'assignfeedback_offline_bath', $updatecount));
    ...
    public function upload_grades() {
        ...
        require_capability('mod/assign:grade', $this->assignment->get_context());
        require_once($CFG->dirroot . '/mod/assign/feedback/offline_bath/uploadgradesform.php');
        require_once($CFG->dirroot . '/mod/assign/feedback/offline_bath/importgradesform.php');
        require_once($CFG->dirroot . '/mod/assign/feedback/offline_bath/importgradeslib.php');
        require_once($CFG->libdir . '/csvlib.class.php');

        $mform = new assignfeedback_offline_bath_upload_grades_form(null,
        ...
        if ($mform->is_cancelled()) {
            ...
            $importid = csv_import_reader::get_new_iid('assignfeedback_offline_bath');
            $gradeimporter = new assignfeedback_offline_bath_grade_importer($importid, $this->assignment);
            ...
            $mform = new assignfeedback_offline_bath_import_grades_form(null, array('assignment'=>$this->assignment,
                                                                       'csvdata'=>$csvdata,
            ...
            $o .= $renderer->render(new assign_header($this->assignment->get_instance(),
                                                            ...
                                                            false,
                                                            $this->assignment->get_course_module()->id,
                                                            get_string('confirmimport', 'assignfeedback_offline_bath')));
            ...
            $o .= $renderer->render(new assign_header($this->assignment->get_instance(),
                                                            ...
                                                            false,
                                                            $this->assignment->get_course_module()->id,
                                                            get_string('uploadgrades', 'assignfeedback_offline_bath')));
    ...
    public function download_grades() {
        ...
        require_once($CFG->dirroot . '/mod/assign/feedback/offline_bath/assign_grading_table_bath.php');
        ...
        //SOT creates the filename of the file that will be downloaded
        $filename = clean_filename(get_string('offline_bathgradingworksheet', 'assignfeedback_offline_bath') . '-' .
